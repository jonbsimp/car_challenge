...
p my_tesla2.lights("on")
p my_toyota.signal("left")
p my_toyota2.signal("right")

cars = [my_tesla, my_tesla2, my_toyota, my_toyota2, my_honda, my_honda2]
sort_year = cars.sort_by { |element| element.year }
sort_model = cars.sort_by { |element| element.model }
sort_cars = cars.sort_by { |element| [element.make, element.year] }

# sort_year.each() do |element|
#   p element.info
# end

# sort_model.each() do |element|
#   p element.info
# end

sort_cars.each() do |element|
    p element.info
end
